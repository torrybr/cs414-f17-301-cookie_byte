...
public class  Game {
	...
	public Game (String GameID, User Player1, User Player2){
	...
	public Game (String GameID, User Player1, User Player2, Board savedGame, User CurrentTurn){
	...
	public Game (String GameID, User Player1, User Player2, List<String> pieceLocations, User CurrentTurn){
		...
		this.GameID = GameID;
		this.CurrentTurn= CurrentTurn;
		board = new Board(pieceLocations,Player1,Player2);
	}
